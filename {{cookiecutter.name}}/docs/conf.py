...
extlinks = {
    "issue": (
        "https://github.com/{{ cookiecutter.github_owner }}/{{ cookiecutter.github_repo }}/issues/%s",
        "💬 %s",
    ),
    "pull": (
        "https://github.com/{{ cookiecutter.github_owner }}/{{ cookiecutter.github_repo }}/pull/%s",
        "🚀 %s",
    ),
    "tag": (
        "https://github.com/{{ cookiecutter.github_owner }}/{{ cookiecutter.github_repo }}/releases/tag/%s",
        "🏷️ %s",
    ),
}
